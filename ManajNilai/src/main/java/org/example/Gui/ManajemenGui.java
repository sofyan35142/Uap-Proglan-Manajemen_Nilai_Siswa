...
// Show corresponding form based on menu selection
        ...
        private JPanel createTambahSiswaForm() {
            ...
            String[] fotoPath = {""}; // Array used to store foto path, as it needs to be updated inside the action listener
            ...
            uploadFotoButton.addActionListener(e -> {
                ...
                if (returnValue == JFileChooser.APPROVE_OPTION) {
                    ...
                    fotoPath[0] = selectedFile.getAbsolutePath(); // Store the file path in the array
            ...
            submitButton.addActionListener(e -> {
                ...
                // If no photo is selected, set fotoPath as empty string
                String selectedFotoPath = fotoPath[0];

                // Now you can call the tambahSiswa method with the correct parameters
                manajemen.tambahSiswa(nama, nis, kelas, selectedFotoPath); // Pass fotoPath here
